...
<body class="light-mode" oncontextmenu="return false;" oncopy="return false;" oncut="return false;" onselectstart="return false;">
    ...
    <nav class="navbar">
        <div class="nav-container">
            <div class="brand">
                <img class="logo-svg logo-dark" src="/assets/3.png" alt="Psimmetry Logo">
                <img class="logo-svg logo-light" src="/assets/5.png" alt="Psimmetry Logo">
                <span class="brand-name">Psimmetry</span>
            </div>
            ...
            <div class="nav-right-controls">
                ...
                <button id="theme-toggle" class="theme-toggle" aria-label="Toggle Light/Dark Mode" title="Toggle Theme">
                    <svg id="icon-sun" style="display: none;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M12 18C8.68629 18 6 15.3137 6 12C6 8.68629 8.68629 6 12 6C15.3137 6 18 8.68629 18 12C18 15.3137 15.3137 18 12 18ZM12 16C14.2091 16 16 14.2091 16 12C16 9.79086 14.2091 8 12 8C9.79086 8 8 9.79086 8 12C8 14.2091 9.79086 16 12 16ZM11 1H13V4H11V1ZM11 20H13V23H11V20ZM3.51472 4.92893L4.92893 3.51472L7.05025 5.63604L5.63604 7.05025L3.51472 4.92893ZM16.9497 18.364L18.364 16.9497L20.4853 19.0711L19.0711 20.4853L16.9497 18.364ZM19.0711 3.51472L20.4853 4.92893L18.364 7.05025L16.9497 5.63604L19.0711 3.51472ZM5.63604 16.9497L7.05025 18.364L4.92893 20.4853L3.51472 19.0711L5.63604 16.9497ZM23 11V13H20V11H23ZM4 11V13H1V11H4Z"/>
                    </svg>
                    <svg id="icon-moon" style="display: block;" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M10 7C10 10.866 13.134 14 17 14C18.9584 14 20.729 13.1957 22.0046 11.9126C21.7588 17.5144 17.1517 22 11.5 22C5.70101 22 1 17.299 1 11.5C1 5.92211 5.4312 1.37894 10.963 1.01168C9.72265 2.53503 9 4.47515 9 6.5C9 6.6681 9.00693 6.8347 9.02058 7H10ZM11.1352 2.99304C6.5401 3.32757 2.91522 7.15546 3 11.7547C3.08581 16.4259 6.94218 20.1415 11.6139 20.0835C16.1408 20.0272 19.8225 16.4801 20.0215 11.9863C19.0838 12.0628 18.0673 12 17 12C12.0294 12 8 7.97056 8 3C8 2.98188 8.00007 2.96378 8.00021 2.94569C8.98621 2.95556 10.016 2.9715 11.1352 2.99304Z"/>
                    </svg>
                </button>
            </div>
        </div>
    ...
    <main class="container">
        ...
        <section id="section-a" class="main-document">
            ...
            <h3>2. What is expected of you</h3>
            <ul>
                <li><strong>Part 1: The Written Brief | Within the 60 Minutes:</strong> Review the case study information of Digitech Leadership Pty Ltd. Distil the information into a brief, strategic, boardroom-ready framework outlining your strategic approach, action steps, resource requirements, risk factors and dependencies. The one-pager note serves as your future strategic framework.</li>
                <li><strong>Part 2: The Presentation | A Summary (20 Minutes):</strong> Structure and use the framework mentioned above to verbally present your strategic approach to the National Sales Director and executive panel.</li>
            </ul>
        </section>

        <section id="section-b" class="main-document">
            ...
            <ul>
                <li><strong>Segment Alpha (Generative AI Architecture):</strong> High-margin, digital infrastructure platforms used by large enterprises to redesign internal workflows, automate data analysis and decision-making processes. Segment Alpha is exclusively owned by Digitech Leadership.</li>
                <li><strong>Segment Beta (Enterprise Database Suites):</strong> A stable, high-performing operational data platform solutions’ asset with notable local market penetration, serving as the company's traditional revenue driver.</li>
                <li><strong>Segment Gamma (Advanced Spreadsheet Modules):</strong> Legacy analytical tools. Segment Gamma is facing aggressive competition from other companies that offer similar digital infrastructures, usually subscription based. Competitors operate in the Digitech Leadership market segments.</li>
                <li><strong>Segment Delta (Legacy Workflow Systems):</strong> This basic platform product line is showing a contraction in market share and is deemed as outdated. The current Workflow System solutions are based on the principle of providing a single-need-solution product.</li>
            </ul>

            <h3>3. Executive Architecture and Reporting Lines</h3>
            <p>Aiming for market excellence, Digitech Leadership operates within a corporate matrix. Regional leadership exercises decision-making within their respective geographical areas. Regional Directors report directly to the National Sales Director and collaborate with Head Office’s functional leadership.</p>

            <div class="org-tree">
                <div class="org-node primary" style="max-width: 320px;">Chief Executive Officer (CEO)</div>
                ...
                <div class="org-split">
                    <div class="org-branch">
                        ...
                        <div class="org-node">
                            Head Office Functional Leadership (ExCo)
                            <ul>
                                <li>Corporate Finance</li>
                                <li>Corporate System Development, AI-Engineering & Governance</li>
                                <li>Corporate Administration & Support Services</li>
                                <li>Corporate Sales & Marketing Coordination</li>
                                <li>Corporate Human Capital (HR) Services</li>
                                <li>Corporate Client Contact Centre</li>
                                <li>Head of Strategic Transformation</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="org-branch">
                        ...
                        <div class="org-node primary">
                            ...
                            <span style="font-size: 0.85em; font-weight: normal; color: var(--text-muted);">(Your line manager / ExCo Member)</span>
                        </div>
                        <div class="org-line-v"></div>
                        <div class="org-node">
                ...
                <div class="org-collab">
                    Regional Directors collaborate directly with Head Office Functional Leadership
                </div>
            </div>
            <p>The Head Office (Gauteng) functions are structured within the roles and departments outlined above. The various heads of departments constitute the corporate ExCo.</p>

            <h3>4. Operational Model</h3>
            <p>The Regions, including the Western Cape operate as independent business units. Sales Executives handle proactive customer acquisition and renewal contracts. The remuneration structure is based on guaranteed pay (salary) and commission incentives/rewards.</p>
        ...
        <section id="section-c" class="main-document">
            ...
            <div class="table-container">
                <table>
                    <caption>Table 1: Sales Executives’ Performance and Remuneration (FY<?php echo date('Y') - 1; ?>)</caption>
                    <thead>
                        <tr>
                            ...
                            <th>Annual Target</th>
                            <th>Total Commission Paid (Excluding additional incentives)</th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <p>In terms of the Sales Executives’ Competency Audit, the following insights were provided (Table 3).</p>

            <div class="table-container">
                <table>
                    <caption>Table 3: Behavioural Competence & Capability Matrix (Sales Executives)<br>
                    <span style="font-size: 0.9rem; font-weight: normal; color: var(--text-muted); margin-top: 0.5rem; display: inline-block;">Rating Index: 4 = Exemplary (Exceeds Norm Continuously) | 3 = Proficient (Acceptable Baseline) | 2 = Developing Gaps Identified | 1 = Far below requirements (Potential Risk)</span></caption>
                    <thead>
                        <tr>
                            <th>Core Executive Competency</th>
                            <th>Thabo M.</th>
                            <th>Sarah R.</th>
                            <th>Deon B.</th>
                            <th>Zola G.</th>
                    ...
                    <tbody>
                        ...
                        <tr><td>Age of Employee</td><td>55</td><td>28</td><td>35</td><td>25</td><td>45</td><td>21</td><td>23</td><td>32</td></tr>
            ...
            <p>A regional client satisfaction survey analysis for <?php echo date('Y') - 1; ?> revealed the following:</p>
            <ul>
                <li>Clients indicate that the Western Cape regions’ response time to infrastructure queries is slow.</li>
                <li>Sales Executives are criticized by some clients for demonstrating "questionable technical knowledge”. Apparently, they focus sales energy on legacy / outdated product solutions while little time is spent on Digitech’s integrated transformation tools and solutions.</li>
            </ul>
        </section>

        <section id="section-d" class="main-document">
            <h2>Section D: Global Horizon & Macro Trends</h2>
            
            <p><strong>Executive Brief Notice Board</strong><br>
    ...
    <script>
        ...
        if (currentTheme === 'dark') {
            ...
            // Default to light mode (body already has class="light-mode")
        ...
        // Scroll to Top & Scroll Spy Functionality
        ...
        window.addEventListener('scroll', () => {
            ...
            if (sectionB) {
                ...
                if (sectionBTop <= window.innerHeight * 0.8) {
            ...
            sections.forEach(section => {
                ...
                // Offset calculation (150px) to match the fixed navbar and padding
                if (window.scrollY >= sectionTop - 150) {
                    current = section.getAttribute('id');
                }
            });

            // 3. Check if at the absolute bottom of the page to highlight the last section
